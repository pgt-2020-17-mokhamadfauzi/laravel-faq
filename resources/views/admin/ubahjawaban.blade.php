        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Ubah Jawaban</h3>
                </div>
                <form action="/admin/sudahdijawab/ubahpost" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body text-right" style="margin-top:10px">
                            <a href="/admin/sudahdijawab" class="btn btn-danger" style="margin-right:5px">Kembali</a><input type="submit" class="btn btn-success" value="Ubah">
                        </div>
                    </div>
                </form>
            </div>
