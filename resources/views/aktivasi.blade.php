...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <p class="login-box-msg">Silahkan Aktivasi Password Anda</p>

    <form action="/aktivasi/post" method="post">
    {{ csrf_field() }}
     <input type="hidden" name="code" value="{{$id}}">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-success btn-block btn-flat">Aktivasi</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
